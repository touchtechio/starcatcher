...
Gem::Gem(int gemIndex, int gemPixelCount, int pixelStart, OctoWS2811* strip, Shader* shader)
{
...
// helper method to calc pixel positions
int getStripLedIndex(int pixel, int pixelStart) {
  return pixel+pixelStart;
}

// draw loop() function for each Gem
void Gem::animate() {
