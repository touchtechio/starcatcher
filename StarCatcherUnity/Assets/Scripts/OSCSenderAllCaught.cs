...
namespace UniOSC{
	...
	[ExecuteInEditMode]
	public class OSCSenderAllCaught: UniOSCEventDispatcher {
        ...
        public void SendOSCAllCaughtMessage(string address, int strip)
        {
            Debug.Log("osc: full caught animation message sent");
        ...
        public void SendOSCMessageDown(){
			...
			this.oscOutAddress = "/1/toggle2";
			//this._oscOutAddress = "/1/toggle2";
